...
<template>
  <div class="progress-bar">
    <div class="header">
      ...
      <i class="fi fi-sr-info" data-info = "Hasło musi zawierać co najmniej 8 znaków,  tym jedną cyfrę (0-9), jedną wielką literę (A-Z), jedną małą literę (a-z) oraz jeden znak specjalny (!@#$%^&*)."></i>
    </div>
