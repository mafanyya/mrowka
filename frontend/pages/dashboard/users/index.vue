...
const {
  ...
  refresh: refreshStatisticsUsers,
  pending: statisticsPending
} = await useFetch('http://localhost:8000/api/users/count')
</script>
...
//border: 1px solid green; width: 65%;
  display: flex;
...
//border: 1px solid orange; width: 35%;
  display: flex;
  flex-direction: column;
}

.local-container .main .clm-2 .row-1 {
//border: 1px solid red; height: 60%;
}

.local-container .main .clm-2 .row-2 {
//border: 1px solid orange; height: 40%;
}
