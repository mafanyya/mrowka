...
.local-container .main .no-data-wrapper .row-1 {
  display: flex;
  align-items: end;
}

.local-container .main .no-data-wrapper .row-1 .error-header-1 {
  font-size: 3rem;
  color: #DE7C7C;
}

.local-container .main .no-data-wrapper .row-1 .error-header-2 {
  font-size: 2.5rem;
  color: #727272;
  margin-left: 0.5rem;
}

.local-container .main .no-data-wrapper .error-content {
  margin-top: 2rem;
  margin-bottom: 2rem;
  font-size: 1rem;
  color: #727272;
...
.local-container .main .no-data-wrapper .refresh-btn {
  font-size: 1.3rem;
  cursor: pointer;
  color: #727272;
}

.local-container .main .no-data-wrapper .refreshing {
  font-size: 1.3rem;
  color: #727272;
}

.local-container .main .no-data-wrapper .refresh-btn:hover {
...
.local-container .main .lesson-wrapper .row-1 .lesson-title {
  font-size: 2.5rem;
  color: #6D7BBC;
}
